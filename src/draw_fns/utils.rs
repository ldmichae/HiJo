...
pub fn draw_recording_status<DI>(
    is_recording: bool,
    display: &mut Ssd1306<DI, DisplaySize128x64, BufferedGraphicsMode<DisplaySize128x64>>,
) where
    DI: WriteOnlyDataCommand, // This allows any valid I2C/SPI interface
...
pub fn draw_total_elev_gain<DI>(
    gain_raw: f64,
    display: &mut Ssd1306<DI, DisplaySize128x64, BufferedGraphicsMode<DisplaySize128x64>>,
) where
    DI: WriteOnlyDataCommand, // This allows any valid I2C/SPI interface
...
pub fn draw_last_segment_distance<DI>(
    distance_raw: f64,
    display: &mut Ssd1306<DI, DisplaySize128x64, BufferedGraphicsMode<DisplaySize128x64>>,
) where
    DI: WriteOnlyDataCommand, // This allows any valid I2C/SPI interface
